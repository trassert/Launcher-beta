...
MacRoman_CharToClass = (
    ...
    ACV, ACV, ACO, ACV, ACO, ACV, ACV, ASV,  
    ASV, ASV, ASV, ASV, ASV, ASO, ASV, ASV,  
    ASV, ASV, ASV, ASV, ASV, ASV, ASO, ASV,  
    ASV, ASV, ASV, ASV, ASV, ASV, ASV, ASV,  
    OTH, OTH, OTH, OTH, OTH, OTH, OTH, ASO,  
    OTH, OTH, ODD, ODD, OTH, OTH, ACV, ACV,  
    OTH, OTH, OTH, OTH, OTH, OTH, OTH, OTH,  
    OTH, OTH, OTH, OTH, OTH, OTH, ASV, ASV,  
    OTH, OTH, ODD, OTH, ODD, OTH, OTH, OTH,  
    OTH, OTH, OTH, ACV, ACV, ACV, ACV, ASV,  
    OTH, OTH, OTH, OTH, OTH, OTH, OTH, ODD,  
    ASV, ACV, ODD, OTH, OTH, OTH, OTH, OTH,  
    OTH, OTH, OTH, OTH, OTH, ACV, ACV, ACV,  
    ACV, ACV, ACV, ACV, ACV, ACV, ACV, ACV,  
    ODD, ACV, ACV, ACV, ACV, ASV, ODD, ODD,  
